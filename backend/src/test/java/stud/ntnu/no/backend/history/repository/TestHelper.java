...
/**
 * Helper class for providing test entities for History repository tests.
 */
public class TestHelper {
     ...
     * 
     * @param entityManager test entity manager
     * @param user the user viewing the item
     * @param item the item being viewed
     * @param viewedAt when the item was viewed
     * @param active whether the history entry is active
     * @return the created and persisted history
     */
