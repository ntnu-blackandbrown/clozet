...
@EnableJpaRepositories(basePackages = {"stud.ntnu.no.backend.review.repository"})
@ComponentScan(
    basePackages = {"stud.ntnu.no.backend.review.repository"},
    excludeFilters = {
...
public class ReviewRepositoryTestConfig {
