...
@EnableJpaRepositories(basePackages = {"stud.ntnu.no.backend.favorite.repository"})
@ComponentScan(
    basePackages = {"stud.ntnu.no.backend.favorite.repository"},
    excludeFilters = {
...
public class FavoriteRepositoryTestConfig {
