...
class JwtAuthenticationFilterTest {
    ...
    @Test
    void doFilterInternal_WithoutCookies_ShouldNotAuthenticate() throws ServletException, IOException {
        // Given
    ...
    @Test
    void doFilterInternal_WithoutJwtCookie_ShouldNotAuthenticate() throws ServletException, IOException {
        // Given
    ...
    @Test
    void doFilterInternal_WithExceptionDuringProcessing_ShouldContinueFilterChain() throws ServletException, IOException {
        // Given
        Cookie jwtCookie = new Cookie("jwt", VALID_TOKEN);
        Cookie[] cookies = {jwtCookie};
