...
/**
 * Helper class for providing test entities for Review repository tests.
 */
public class TestHelper {
    ...
    /**
     * Creates a basic transaction with necessary fields.
     * 
     * @param entityManager test entity manager
     ...
     */
    public static Transaction createTransaction(TestEntityManager entityManager, User buyer, User seller, Item item, double amount) {
    ...
    /**
     * Creates a review with required fields.
     * 
     * @param entityManager test entity manager
     * @param reviewer user who wrote the review
     * @param reviewee user who was reviewed
