...
/**
 * Helper class for providing test entities for Message repository tests.
 */
public class TestHelper {
    ...
    /**
     * Creates a basic message with required fields.
     * 
     * @param entityManager test entity manager
     ...
     */
    public static Message createMessage(TestEntityManager entityManager, User sender, User receiver, Item item, String content) {
