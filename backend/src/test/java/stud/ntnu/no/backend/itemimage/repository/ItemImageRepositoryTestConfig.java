...
@EnableJpaRepositories(basePackages = {"stud.ntnu.no.backend.itemimage.repository"})
@ComponentScan(
    basePackages = {"stud.ntnu.no.backend.itemimage.repository"},
    excludeFilters = {
...
public class ItemImageRepositoryTestConfig {
