...
public class TestHelper {
     ...
     */
    public static Transaction createTransaction(TestEntityManager entityManager, User buyer, User seller, 
                                              Item item, double amount, String status, LocalDateTime createdAt) {
