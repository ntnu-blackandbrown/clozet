...
class TransactionControllerTest {
  ...
  void getTransactionById_ShouldReturnTransaction() throws Exception {
    ...
    // When/Then
    mockMvc
        .perform(get("/api/transactions/" + transactionId))
        .andExpect(status().isOk())
  ...
  void updateTransaction_ShouldReturnUpdatedTransaction() throws Exception {
    ...
    when(transactionService.updateTransaction(
            eq(transactionId), any(UpdateTransactionRequest.class)))
    ...
    verify(transactionService)
        .updateTransaction(eq(transactionId), any(UpdateTransactionRequest.class));
  }
  ...
  void getTransactionsBetweenDates_ShouldReturnFilteredTransactions() throws Exception {
    ...
    when(transactionService.findByCreatedAtBetween(
  ...
  void purchaseItem_ShouldReturnCreatedTransaction() throws Exception {
    ...
    when(transactionService.handlePurchaseTransaction(any(CreateTransactionRequest.class)))
        .thenReturn(createdTransaction);
