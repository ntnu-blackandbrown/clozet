...
@EnableJpaRepositories(basePackages = {"stud.ntnu.no.backend.history.repository"})
@ComponentScan(
    basePackages = {"stud.ntnu.no.backend.history.repository"},
    excludeFilters = {
...
public class HistoryRepositoryTestConfig {
