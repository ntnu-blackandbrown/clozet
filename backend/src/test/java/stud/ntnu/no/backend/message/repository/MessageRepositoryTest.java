...
public class MessageRepositoryTest {
  ...
  public void testFindBySenderIdOrReceiverId_WhenUserIsSender_ShouldReturnMessages() {
    ...
    Message message1 =
        TestHelper.createMessage(entityManager, sender, receiver, item, "Hello from sender");
    Message message2 =
        TestHelper.createMessage(entityManager, receiver, sender, item, "Hello from receiver");
  ...
  public void testFindBySenderIdOrReceiverId_WhenUserIsReceiver_ShouldReturnMessages() {
    ...
    Message message1 =
        TestHelper.createMessage(entityManager, user1, user2, item, "Message from 1 to 2");
    Message message2 =
        TestHelper.createMessage(entityManager, user3, user2, item, "Message from 3 to 2");
    Message message3 =
        TestHelper.createMessage(entityManager, user1, user3, item, "Message from 1 to 3");
