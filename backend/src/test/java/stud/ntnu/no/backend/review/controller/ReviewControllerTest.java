...
class ReviewControllerTest {
  ...
  void getReviewsByReviewee_ShouldReturnReviewsForReviewee() throws Exception {
    ...
    // When/Then
    mockMvc
        .perform(get("/api/reviews/reviewee/" + revieweeId))
        .andExpect(status().isOk())
        .andExpect(jsonPath("$[0].id").value(1))
  ...
  void getReviewsByReviewer_ShouldReturnReviewsFromReviewer() throws Exception {
    ...
    // When/Then
    mockMvc
        .perform(get("/api/reviews/reviewer/" + reviewerId))
        .andExpect(status().isOk())
        .andExpect(jsonPath("$[0].id").value(1))
            ...
            document(
                ...
                requestFields(
                    ...
                    fieldWithPath("transactionId")
                        .description("ID of the associated transaction")
                        .optional(),
                    fieldWithPath("revieweeUsername")
                        .description("Username of the reviewee")
                        .optional(),
                    fieldWithPath("reviewerUsername")
  ...
  void deleteReview_ShouldReturnNoContent() throws Exception {
    ...
    // When/Then
    mockMvc
        .perform(delete("/api/reviews/" + reviewId))
