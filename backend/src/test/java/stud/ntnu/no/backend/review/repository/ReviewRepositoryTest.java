...
public class ReviewRepositoryTest {
    ...
    public void testFindByRevieweeId_WhenReviewsExist_ShouldReturnReviews() {
        ...
        Transaction transaction1 = TestHelper.createTransaction(entityManager, buyer1, seller, item1, 100.0);
        Transaction transaction2 = TestHelper.createTransaction(entityManager, buyer2, seller, item2, 200.0);
        ...
        assertThat(reviews).extracting(r -> r.getReviewer().getUsername())
                          .containsExactlyInAnyOrder("buyer1", "buyer2");
        assertThat(reviews).extracting(Review::getRating)
    ...
    public void testFindByReviewerId_WhenReviewsExist_ShouldReturnReviews() {
        ...
        Transaction transaction1 = TestHelper.createTransaction(entityManager, buyer, seller1, item1, 100.0);
        Transaction transaction2 = TestHelper.createTransaction(entityManager, buyer, seller2, item2, 200.0);
        ...
        // Assert
        assertThat(reviews).hasSize(2);
        assertThat(reviews).extracting(r -> r.getReviewee().getUsername())
    ...
    public void testFindByTransactionId_WhenReviewExists_ShouldReturnReview() {
        ...
        Transaction transaction = TestHelper.createTransaction(entityManager, buyer, seller, item, 150.0);
        
        Review review = TestHelper.createReview(entityManager, buyer, seller, transaction, 4, "Good seller");
