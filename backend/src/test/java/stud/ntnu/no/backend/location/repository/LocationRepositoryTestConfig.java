...
@EnableJpaRepositories(basePackages = {"stud.ntnu.no.backend.location.repository"})
@ComponentScan(
    basePackages = {"stud.ntnu.no.backend.location.repository"},
    excludeFilters = {
...
public class LocationRepositoryTestConfig {
