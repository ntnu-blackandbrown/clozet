...
@EnableJpaRepositories(basePackages = {"stud.ntnu.no.backend.shippingoption.repository"})
@ComponentScan(
    basePackages = {"stud.ntnu.no.backend.shippingoption.repository"},
    excludeFilters = {
...
public class ShippingOptionRepositoryTestConfig {
