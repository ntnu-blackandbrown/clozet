...
class ShippingOptionServiceImplTest {
    ...
    @InjectMocks
    private ShippingOptionServiceImpl shippingOptionService;
    ...
    void getShippingOption_NonExistingId_ThrowsException() {
        ...
        // Act & Assert
        assertThrows(ShippingOptionNotFoundException.class, () -> {
    ...
    void createShippingOption_EmptyName_ThrowsException() {
        ...
        // Act & Assert
        assertThrows(ShippingOptionValidationException.class, () -> {
    ...
    void updateShippingOption_ExistingId_ReturnsUpdatedShippingOption() {
        ...
        // Act
        ShippingOptionDTO result = shippingOptionService.updateShippingOption(shippingOptionId, updateDTO);
