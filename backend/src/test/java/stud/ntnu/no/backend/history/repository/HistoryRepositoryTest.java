...
public class HistoryRepositoryTest {
    ...
    @Test
    public void testFindByUserAndActiveOrderByViewedAtDesc_WhenActive_ShouldReturnOnlyActiveHistory() {
        // Arrange
        User user = TestHelper.createUser(entityManager, "user", "user@example.com");
        User seller = TestHelper.createUser(entityManager, "seller", "seller@example.com");
        ...
        // Act
        List<History> activeHistory = historyRepository.findByUserAndActiveOrderByViewedAtDesc(user, true);
    ...
    public void testFindByUserAndItem_WhenHistoryExists_ShouldReturnHistory() {
        ...
        History history = TestHelper.createHistory(entityManager, user, item, LocalDateTime.now(), true);
