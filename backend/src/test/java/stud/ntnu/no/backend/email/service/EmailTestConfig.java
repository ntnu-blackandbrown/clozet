...
/**
 * Test configuration for email-related tests.
 * This ensures that even when using the 'test' profile,
...
public class EmailTestConfig {
    ...
    /**
     * Creates a no-op JavaMailSender for test cases.
     * This prevents tests from trying to connect to real mail servers.
     */
    @Bean
    @Primary
