...
@EnableJpaRepositories(basePackages = {"stud.ntnu.no.backend.transaction.repository"})
@ComponentScan(
    basePackages = {"stud.ntnu.no.backend.transaction.repository"},
    excludeFilters = {
...
public class TransactionRepositoryTestConfig {
