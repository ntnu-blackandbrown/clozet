...
public class ItemServiceImplTest {
    ...
    void createItem_withValidData_shouldReturnCreatedItem() {
        ...
        when(itemMapper.toEntity(eq(createItemDTO), eq(category), eq(seller), eq(location), eq(shippingOption)))
                .thenReturn(newItem);
        ...
        verify(itemMapper, times(1)).toEntity(eq(createItemDTO), eq(category), eq(seller), eq(location), eq(shippingOption));
