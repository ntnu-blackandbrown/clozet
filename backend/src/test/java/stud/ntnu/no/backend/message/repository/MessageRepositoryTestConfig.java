...
@EnableJpaRepositories(basePackages = {"stud.ntnu.no.backend.message.repository"})
@ComponentScan(
    basePackages = {"stud.ntnu.no.backend.message.repository"},
    excludeFilters = {
...
public class MessageRepositoryTestConfig {
