 ...
 * <p>
 * This exception is thrown when an operation attempts to access or manipulate a user that does not
 * exist in the database, such as when retrieving a user by ID or username that does not match any
 * existing record.
 * </p>
 * <p>
...
public class UserNotFoundException extends BaseException {
   ...
   * <p>
   * This constructor allows for more specific error messages, such as when searching for a user by
   * username or email.
   * </p>
   *
