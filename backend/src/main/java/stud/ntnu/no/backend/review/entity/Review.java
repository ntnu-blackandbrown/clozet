 ...
 * <p>
 * This class is mapped to the "REVIEWS" table in the database and holds
 * information about a review, including its ID, comment, rating, creation time,
 * reviewee, reviewer, and associated transaction.
 */
@Entity
@Table(name = "REVIEWS")
public class Review {
