 ...
 * <p>
 * This service provides methods for user management including creation, retrieval,
 * authentication, verification, and profile management. Implementations of this class
 * should handle business logic related to users while communicating with the
 * appropriate repositories and external services.
 * </p>
 */
public abstract class UserService {
     ...
     * @return the UserDTO representing the requested user
     * @throws stud.ntnu.no.backend.user.exception.UserNotFoundException if no user with the given username exists
     */
     ...
     * @throws stud.ntnu.no.backend.user.exception.UsernameAlreadyExistsException if the username is already taken
     * @throws stud.ntnu.no.backend.user.exception.EmailAlreadyInUseException if the email is already in use
    ...
    /**
     * Creates a new user and sends a verification email to the user's email address.
     * The user account will be inactive until verified.
     *
     * @param registerUserDTO the data transfer object containing user registration information
     * @throws stud.ntnu.no.backend.user.exception.UsernameAlreadyExistsException if the username is already taken
     * @throws stud.ntnu.no.backend.user.exception.EmailAlreadyInUseException if the email is already in use
     ...
     * @throws stud.ntnu.no.backend.user.exception.UserNotFoundException if no user with the given username exists
     * @throws org.springframework.security.authentication.BadCredentialsException if the old password is incorrect
     */
     ...
     * @throws stud.ntnu.no.backend.user.exception.UserNotFoundException if the authenticated user cannot be found
     */
