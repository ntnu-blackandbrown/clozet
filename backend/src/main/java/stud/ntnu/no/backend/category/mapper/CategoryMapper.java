...
/**
 * MapStruct mapper interface for conversion between Category entities and DTOs.
 * Provides automatic mapping with custom transformations for complex fields.
 */
...
public interface CategoryMapper {
     ...
     * Maps parent category ID and name, and converts subcategories to a list of IDs.
     *
     ...
     * Ignores fields that should be managed separately (subcategories, items).
     *
