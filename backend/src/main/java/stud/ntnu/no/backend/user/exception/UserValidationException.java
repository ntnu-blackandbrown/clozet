 ...
 *
 * <p>This exception is thrown when user data fails validation checks, such as invalid email format,
 ...
 *
 * <p>In REST API responses, this exception typically results in a 400 Bad Request HTTP status code.
 */
public class UserValidationException extends BaseException {
   ...
   *
   * <p>The message should describe which validation constraint was violated and, if possible, how
   * to fix the issue.
   *
