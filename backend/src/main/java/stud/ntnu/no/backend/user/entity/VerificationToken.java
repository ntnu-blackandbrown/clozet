 ...
 * <p>
 * This entity stores tokens that are sent to users via email during registration
 * to verify their email address. Each token has an expiration date and is linked
 * to a specific user. Once a token is used for verification, it can be deleted.
 * </p>
 * <p>
 * The verification process helps ensure that email addresses are valid and
 * belong to the user who registered, reducing the risk of spam and fake accounts.
 * </p>
 */
@Entity
...
public class VerificationToken {
    ...
    /**
     * The actual token string sent to the user for verification.
     * Must be unique to prevent conflicts and cannot be null.
     */
     ...
     * Cannot be null as all tokens must have an expiry date for security reasons.
     */
     ...
     * One-to-one relationship as each token belongs to exactly one user.
     */
     ...
     * Protected to prevent direct instantiation without required fields.
     */
     ...
     * <p>
     * This constructor ensures that all required fields are provided when creating
