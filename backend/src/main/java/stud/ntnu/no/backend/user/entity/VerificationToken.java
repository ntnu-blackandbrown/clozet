 ...
 *
 * <p>This entity stores tokens that are sent to users via email during registration to verify their
 ...
 *
 * <p>The verification process helps ensure that email addresses are valid and belong to the user
 * who registered, reducing the risk of spam and fake accounts.
 */
@Entity
...
public class VerificationToken {
  ...
  /**
   * Default constructor for JPA. Protected to prevent direct instantiation without required fields.
   */
   ...
   *
   * <p>This constructor ensures that all required fields are provided when creating a new
   * verification token.
   *
   ...
   *
   * <p>This method is useful for validation before processing a verification request.
   *
