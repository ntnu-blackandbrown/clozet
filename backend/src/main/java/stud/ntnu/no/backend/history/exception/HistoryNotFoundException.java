 ...
 * <p>
 * This exception is thrown when an operation attempts to retrieve, update, or 
 * delete a history record that does not exist in the database.
 * </p>
 * <p>
 * In REST API responses, this exception typically results in a 404 Not Found
 * HTTP status code.
 * </p>
 */
public class HistoryNotFoundException extends BaseException {
     ...
     * <p>
     * The message should provide information about which history record could not
     * be found and, if relevant, how it was being searched for (ID, user, etc.).
     * </p>
     *
    ...
    /**
     * Constructs a new HistoryNotFoundException with a message indicating the history ID
