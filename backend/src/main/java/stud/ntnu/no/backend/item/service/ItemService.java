 ...
 * <p>
 * This interface defines the core business operations for managing items in the marketplace.
 * It provides methods for creating, retrieving, updating, and deleting items, as well as
 * specialized operations like activating and deactivating items. All methods that modify items
 * include seller validation to ensure that only the item owner can make changes.
 * </p>
 */
public interface ItemService {
     ...
     * @throws stud.ntnu.no.backend.item.exception.ItemNotFoundException if no item exists with the given ID
     */
     ...
     * @param sellerId the unique identifier of the seller making the update (for ownership verification)
     * @return the updated item
     * @throws stud.ntnu.no.backend.item.exception.ItemNotFoundException if no item exists with the given ID
     * @throws stud.ntnu.no.backend.item.exception.ItemValidationException if the item data is invalid
     * @throws org.springframework.security.access.AccessDeniedException if the specified seller is not the owner of the item
     */
     ...
     * @param sellerId the unique identifier of the seller making the change (for ownership verification)
     * @throws stud.ntnu.no.backend.item.exception.ItemNotFoundException if no item exists with the given ID
     * @throws org.springframework.security.access.AccessDeniedException if the specified seller is not the owner of the item
     */
