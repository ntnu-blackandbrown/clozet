...
/**
 * Repository interface for database operations related to Category entities. Extends JpaRepository
...
public interface CategoryRepository extends JpaRepository<Category, Long> {
  ...
  /**
   * Finds categories ordered by the number of times items in the category have been favorited. Uses
   * pagination to limit the result set.
   *
  ...
  /**
   * Finds categories ordered by the number of items in the category. Uses pagination to limit the
   * result set.
   *
   * @param pageable Pagination information
