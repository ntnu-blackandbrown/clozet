...
public class DatabaseInitializer {
  ...
  protected List<ShippingOption> createShippingOptions() {
    ...
    internationalOption.setDescription(
        "Delivery to countries outside Norway within 7-14 business days");
  ...
  protected List<Item> createItemsForUser(User seller, int count, Map<String, Category> categories,
    ...
    categoryItemIndices.put("mens_pants", List.of(1));
    categoryItemIndices.put("mens_jackets", Arrays.asList(3, 5));
    categoryItemIndices.put("mens_shoes", List.of(6));
    categoryItemIndices.put("mens_formal_wear", List.of(4));

    categoryItemIndices.put("womens_tops", Arrays.asList(8, 12));
    categoryItemIndices.put("womens_pants", List.of(9));
    categoryItemIndices.put("womens_dresses", List.of(10));
    categoryItemIndices.put("womens_jackets", List.of(11));
    categoryItemIndices.put("womens_shoes", Arrays.asList(13, 14));

    categoryItemIndices.put("boys_clothing", List.of(24));
    categoryItemIndices.put("girls_clothing", List.of(25));
    categoryItemIndices.put("infant_&_toddler", List.of(24));

    categoryItemIndices.put("bags_&_purses", List.of(16));
    categoryItemIndices.put("jewelry", List.of(17));
    categoryItemIndices.put("hats_&_caps", List.of(20));
    categoryItemIndices.put("scarves_&_gloves", List.of(19));
    categoryItemIndices.put("belts", List.of(18));
  ...
  protected void createTransactions(Map<User, List<Item>> userItems, User buyer) {
    ...
    for (Map.Entry<User, List<Item>> entry : userItems.entrySet()) {
      if (createdCount >= transactionCount) {
        break;
      }
      ...
      if (!items.isEmpty()) {
        ...
        transaction.setUpdatedAt(
            transactionTime.plusHours(random.nextInt(48))); // Updated within 48 hours
