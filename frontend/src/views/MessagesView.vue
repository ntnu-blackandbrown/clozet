...
const chatMessages = {
  1: [
    ...
    { id: 3, type: 'text', content: 'Processing complete. Results are fascinating.', time: '09:20', sent: true }
  ],
  2: [
    { id: 1, type: 'text', content: 'Hey, did you check the latest design updates?', time: '10:30', sent: false },
    { id: 2, type: 'file', fileName: 'design_v2.pdf', fileSize: '3.2mb', time: '10:31', sent: false },
    { id: 3, type: 'text', content: 'Yes, looks great! Just a few minor tweaks needed.', time: '10:45', sent: true }
  ],
  3: [
    { id: 1, type: 'text', content: 'URGENT: Server maintenance required', time: '11:00', sent: false },
    { id: 2, type: 'text', content: 'Multiple issues detected in production', time: '11:01', sent: false },
    { id: 3, type: 'audio', duration: '01:30', time: '11:05', sent: true },
    { id: 4, type: 'text', content: 'Issues resolved. All systems operational.', time: '11:15', sent: true }
  ],
  4: [
  ...
  5: [
    ...
    { id: 2, type: 'file', fileName: 'timeline_2024.xlsx', fileSize: '1.8mb', time: '14:21', sent: false },
    { id: 3, type: 'text', content: 'Thanks, reviewing it now', time: '14:30', sent: true },
    { id: 4, type: 'text', content: 'Looks achievable. Team is already ahead of schedule.', time: '14:35', sent: true }
  ],
  6: [
    ...
    { id: 3, type: 'text', content: 'Yes! What do you think of chapter 3?', time: '15:47', sent: false }
  ],
  7: [
    { id: 1, type: 'audio', duration: '02:45', time: '16:20', sent: false },
    { id: 2, type: 'text', content: 'Your deduction is brilliant as always!', time: '16:25', sent: true }
  ],
  8: [
    { id: 1, type: 'text', content: 'Spring concert rehearsal tonight?', time: '17:00', sent: false },
    { id: 2, type: 'file', fileName: 'sheet_music.pdf', fileSize: '4.5mb', time: '17:01', sent: false },
    { id: 3, type: 'text', content: 'Yes, I will be there. Practicing the new piece now.', time: '17:05', sent: true }
  ],
  9: [
    { id: 1, type: 'text', content: 'New song draft, what do you think?', time: '18:30', sent: false },
    { id: 2, type: 'audio', duration: '03:15', time: '18:31', sent: false },
    { id: 3, type: 'text', content: 'This is amazing! Love the bridge section.', time: '18:40', sent: true }
  ],
  10: [
