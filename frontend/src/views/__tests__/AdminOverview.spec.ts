...
// Mock data
const mockUsers = [
  { id: 1, username: 'testuser1', firstName: 'Test', lastName: 'User1', email: 'test1@example.com', createdAt: '2023-10-26T10:00:00Z' },
  { id: 2, username: 'testuser2', firstName: 'Test', lastName: 'User2', email: 'test2@example.com', createdAt: '2023-10-25T10:00:00Z' },
  { id: 3, username: 'testuser3', firstName: 'Test', lastName: 'User3', email: 'test3@example.com', createdAt: '2023-10-27T10:00:00Z' }, // Ensure recent logic works
  { id: 4, username: 'testuser4', firstName: 'Test', lastName: 'User4', email: 'test4@example.com', createdAt: '2023-10-24T10:00:00Z' },
];
const mockProducts = [
...
describe('AdminOverview.vue', () => {
  beforeEach(() => {
    ...
    (UserService.getAllUsers as MockedFunction<typeof UserService.getAllUsers>).mockResolvedValue(createMockResponse(mockUsers));
    (ProductService.getAllItems as MockedFunction<typeof ProductService.getAllItems>).mockResolvedValue(createMockResponse(mockProducts));
    (CategoryService.getAllCategories as MockedFunction<typeof CategoryService.getAllCategories>).mockResolvedValue(createMockResponse(mockCategories));
    (TransactionService.getAllTransactions as MockedFunction<typeof TransactionService.getAllTransactions>).mockResolvedValue(createMockResponse(mockTransactions));
  });
